...
public class DiagramDataUnflatten1 {
    protected static String PRESNAME_FOR_IMAGE = "image";
    public DiagramDataUnflatten1(DiagramDataPart diagramDataPart) {
    ...
    public SmartArtDataHierarchy convert() {
        ...
        if (docPt.getPrSet()!=null
            ...
            System.out.print("Couldn't read @loTypeId");
        }
    ...
    public static String  mianer() throws Docx4JException, FileNotFoundException {
        OpcPackage pkg = OpcPackage.load(new java.io.File("C:\\Users\\ponnl\\Desktop\\test\\Example.docx"));
        ...
        CTDataModel ct = thisPart.getJaxbElement();
        ...
        try (PrintStream out = new PrintStream(new FileOutputStream("C:\\Users\\ponnl\\Desktop\\data-sample1.xml"))) {
            out.print(exchange);
        }
       // System.out.print(XmlUtils.marshaltoString(XmlUtils.marshaltoString(diagramDataUnflatten, true, true)));
        return  exchange;
    }
